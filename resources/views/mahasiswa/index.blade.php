                    ...
                    <main class="mt-6">
                        <div class="rounded-lg bg-white px-5 py-5 shadow mb-4 text-black">
                            ...
                            <form action="/" method="GET" class="row row-cols-lg-auto g-3">
                                <div class="col-auto">
                                    <input type="text" class="form-control" id="nim" name="nim" placeholder="NIM Mahasiswa" value="{{ $nim?? '' }}" maxlength="10">
                                </div>
                                <div class="col-auto">
                                    <select id="semester" class="form-select" name="semester_id" aria-label="Pilih Semester">
                        ...
                        <div class="rounded-lg bg-white px-5 pt-5 pb-4 shadow text-black">
                            ...
                            <div class="mb-4">
                                <p class="mb-2 fs-5 row">
                                    ...
                                    @if(!empty($selectedMahasiswa)) {{ $selectedMahasiswa->name }} @else - @endif
                                </p>
                                <p class="mb-2 fs-5 row">
